      ...
      <table style="width: 100%; border-collapse: collapse; border-spacing: 0;">
        <tr>
          ...
          <td style="padding: 0; text-align: right;">
            <a href="index.php?editor=npc&z=<?= $currzone ?? "" ?>&zoneid=<?= $currzoneid ?? "" ?>&npcid=<?= $npcid ?>&action=78"><img src="images/c_table.gif" style="border: 0;" alt="View Emotes Icon" title="View all emotes"></a>
            <a href="index.php?editor=npc&z=<?= $currzone ?? "" ?>&zoneid=<?= $currzoneid ?? "" ?>&npcid=<?= $npcid ?>&emoteid=<?= $emoteid ?>&action=79"><img src="images/view_all.gif" style="border: 0;" width="15" alt="View NPCs Icon" title="View NPCs using this emote set"></a>
            <a href="index.php?editor=npc&z=<?= $currzone ?? "" ?>&zoneid=<?= $currzoneid ?? "" ?>&npcid=<?= $npcid ?>&emoteid=<?= $emoteid ?>&action=97"><img src="images/add.gif" style="border: 0;" alt="Add Icon" title="Add an entry to this emote set"></a>
            <?php
            $currzone = $currzone ?? "";
