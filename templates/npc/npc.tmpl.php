								...
								<?foreach($faction_hits as $hit): extract($hit);?>
                                            <tr>
                                                ...
                                                <td align="right">
                                                    ...
                                                    <?if ($temp_ != 0) {?>
                                                        <a href="index.php?editor=npc&z=<?=$currzone?>&zoneid=<?=$currzoneid?>&npcid=<?=$npcid?>&npc_faction_id=<?=$npc_faction_id?>&faction_id=<?=$faction_id?>&action=95"><img src="images/upgrade.gif" border="0" title="Change order"></a>
                        <?} else {?>
                          <a><img src="images/blank.png" border="0"></a>
                          <?$temp_ = 1;?>
                        <?}?>
                        <a href="index.php?editor=npc&z=<?=$currzone?>&zoneid=<?=$currzoneid?>&npcid=<?=$npcid?>&npc_faction_id=<?=$npc_faction_id?>&faction_id=<?=$faction_id?>&action=96"><img src="images/downgrade.gif" border="0" title="Change order"></a>
                                                </td>
                                            </tr>
                                        <?endforeach; ?>
                                    </table>
